...
var CONSUL_NODE = '81.45.22.27:8500';
var DEFAULT_BRANCH = 'develop'; // TODO get branch from the commit information
var FIREBASE_ENDPOINT = 'https://flock-demo.firebaseio.com/'
...
function getPackage(commit, callback) {
    ...
    request.get({url:packageUrl, json:true}, function (err, response, package) {
        // TODO handle error
...
function buildApp(package) {
    ...
    // TODO move to a custom docker image (flock-docker)
